...
using EmailAPIServices.Middlewares;
...
builder.Services.AddTransient<IRequestReplyRepository, RequestReplyRepository>();
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Email API Service V1");
