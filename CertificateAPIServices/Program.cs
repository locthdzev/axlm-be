using System.Text;
using CertificateAPIServices.Middlewares;
...
builder.Configuration.AddJsonFile("appsettings.certificate.json", optional: false, reloadOnChange: true);
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Certificate API Service V1");
